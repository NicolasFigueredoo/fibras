        ...
        <div class="div1">
                <nav id="sidebar" class="sidebar bg-body-light shadow-right" style="height: 100vh;" >
                    ...
                    <ul class="sidebar-nav nav accordion">
                        ...
                        <li class="sidebar-item">
                            <a @click="mostrarComponenteF(130)"  class="nav-link collapsed" data-bs-toggle="collapse" data-bs-target="#collapseMetadatos"
                                aria-expanded="false" aria-controls="collapseMetadatos">
                                <div class="nav-link-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <div class="container-fluid px-2">
                ...
                <div class="">
                    <ul class="navbar-nav ms-automb-lg-0">
                        ...
                        <div class="p-2">
                            <button @click="logout()" type="button"  class="btn btn-danger botonSalir">Salir</button>
                        </div>
