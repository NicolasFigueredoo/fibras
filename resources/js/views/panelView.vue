            ...
            <nav id="sidebar" class="sidebar bg-body-light shadow-right" style="height: 100vh;">
                ...
                <ul class="sidebar-nav nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <div id="collapseProductos" class="collapse">
                            <nav class="sidenav-menu-nested nav ">
                                <a @click="mostrarComponenteF(190)" class="nav-link">Categorias</a>
                            </nav>
                        </div>
...
-->
                   ...
                   <li class="sidebar-item">
                    ...
                    <li class="sidebar-item">
                        <a class="nav-link collapsed" data-bs-toggle="collapse" data-bs-target="#collapseConfiguracion"
                        ...
                        <div id="collapseConfiguracion" class="collapse">
                            <nav class="sidenav-menu-nested nav ">
                                <a @click="mostrarComponenteF(13)" class="nav-link">Contacto</a>
                            </nav>
                        </div>

                        <div id="collapseConfiguracion" class="collapse">
                            <nav class="sidenav-menu-nested nav ">
                                <a @click="mostrarComponenteF(19)" class="nav-link">Logos</a>
                            </nav>
                        </div>
...
.componentesV::-webkit-scrollbar {
    width: 0;  
}

.componentesV::-webkit-scrollbar-track {
    background-color: transparent;  
}

.componentesV::-webkit-scrollbar-thumb {
    background-color: transparent;
}
