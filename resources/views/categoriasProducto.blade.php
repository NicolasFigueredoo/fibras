...
@section('content')
    <div class="container" style="margin-top: 30px; margin-bottom: 174px">
        ...
        @if ($producto !== null)
            ...
            @else
                <p class="indicador"><b>Começar / Produtos / {{ $categoria['nombreAlternativo'] }} </b> / {{ $producto['nombreAlternativo'] }} </p>
            @endif
        @else
            @if ($idiomaActive == 'ES')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="d-flex flex-column">
                                ...
                                <div>
                                    <div>
                                        <p class="categoriaTextProducto" style="color: #00245D">
                                    ...
                                    <div class="productoDescripcion pt-2">
                                        <label class="pb-2" id="labelDescripcion" for=""><b>Descripcion:</b></label>
                                        {!! $producto['texto'] !!}
                                ...
                                <div>
                                    ...
                                    <div class="productoDescripcion pt-2">
                                        <label class="pb-2" id="labelDescripcion" for=""><b>Descrição:</b></label>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        ">
                                            ...
                                            <div class="m-3">
                                                ...
                                                <p class="productoTextInfoRelacion">{{ $producto->nombreAlternativo }}</p>
                                                @endif
                                            </div>
